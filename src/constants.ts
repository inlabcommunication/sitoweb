...
export const WEBSITE_CONTENT = {
  ...
  portfolio: {
    ...
    title: ["LAVORI", "SCELTI"],
    projects: [
      { title: "Reel Virale — Ristorante locale", tag: "video", stat: "840K views", year: "24", large: true },
      { title: "Brand Identity — Studio Medico", tag: "brand", stat: "Rebranding completo", year: "24", large: false },
      { title: "E-commerce — Moda Pugliese", tag: "web", stat: "+340% conversioni", year: "24", large: false },
      { title: "Campaign Social — Negozio Sport", tag: "social", stat: "1.2M reach organico", year: "23", large: true },
      { title: "Shooting — Agriturismo Taranto", tag: "foto", stat: "Portfolio visivo", year: "23", large: false },
      { title: "Landing Page — Studio Legale", tag: "web", stat: "Conversion rate 12%", year: "23", large: false },
    ]
  },
  ...
  contact: {
    ...
    emails: [{ label: "Scrivici", value: "ciao@inlab.it" }],
    phones: [{ label: "Chiamaci", value: "+39 099 000 0000" }],
