...
export const WEBSITE_CONTENT = {
  ...
  clients: {
    ...
    items: [
      {
        id: "nunzio-putignano",
        name: "Nunzio Putignano",
        sector: "Eventi & Branding",
        location: "",
        summary: "Una strategia integrata online e offline per un cambio insegna trasformato in evento locale.",
        description: "Una strategia integrata online e offline per un cambio insegna trasformato in evento locale.",
        services: ["Eventi & Branding"],
        results: [],
        url: "",
        logo: "",
        image: "",
      ...
      },
      {
        ...
        name: "Diram autoricambi",
        sector: "Campagne & Lead",
        location: "",
        summary: "Contenuti, reel e landing page per generare lead qualificati nel settore luce, gas, fotovoltaico.",
        description: "Contenuti, reel e landing page per generare lead qualificati nel settore luce, gas, fotovoltaico.",
        services: ["Campagne & Lead"],
        results: [],
        url: "",
        logo: "",
        image: "",
      ...
      },
      {
        ...
        sector: "Social Media",
        location: "",
        summary: "Piano editoriale e contenuti che alternano educazione, recensioni e posizionamento.",
        description: "Piano editoriale e contenuti che alternano educazione, recensioni e posizionamento.",
      ...
      },
      {
        ...
        sector: "Reel & Video",
        location: "",
        summary: "Storytelling visivo per un settore di nicchia. Riprese, montaggio e narrazione.",
        description: "Storytelling visivo per un settore di nicchia. Riprese, montaggio e narrazione.",
        services: ["Reel & Video"],
        results: [],
        url: "",
        logo: "",
      ...
      {
        id: "ottica-occhiblu",
        name: "Ottica OcchiBlu",
        sector: "Social Media",
        location: "",
        summary: "Contenuti che spiegano un servizio tecnico in modo chiaro e accessibile.",
        description: "Contenuti che spiegano un servizio tecnico in modo chiaro e accessibile.",
        services: ["Social Media"],
        results: [],
        url: "",
        logo: "",
      ...
      },
      {
        id: "sottoscala",
        name: "Sottoscala",
        sector: "Shooting & Reel",
        location: "",
        summary: "Identità visiva food costruita con foto curate e contenuti video ad alto impatto.",
        description: "Identità visiva food costruita con foto curate e contenuti video ad alto impatto.",
        services: ["Shooting & Reel"],
        results: [],
        url: "",
        logo: "",
        image: "",
      ...
      },
      {
        ...
        sector: "Social Media",
        location: "",
        summary: "Presenza social costante e riconoscibile per un brand fortemente legato al territorio.",
        description: "Presenza social costante e riconoscibile per un brand fortemente legato al territorio.",
        services: ["Social Media"],
        results: [],
        url: "",
        logo: "",
      ...
      },
      {
        ...
        description: "Shooting di prodotto e contenuti social per raccontare il rituale del caffè.",
        services: ["Shooting"],
        results: [],
        url: "",
        logo: "",
