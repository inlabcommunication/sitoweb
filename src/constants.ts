  ...
  clients: {
    ...
    items: [
      ...
      },
      {
        ...
        location: "Palagiano (TA)",
        summary: "Studio dentistico a Palagiano: sbiancamento, allineatori, faccette e total lift raccontati con contenuti chiari, educativi e rassicuranti.",
        description: "Lo Studio Dentistico Ricciardi di Palagiano offre trattamenti come sbiancamento, allineatori, faccette e total lift. Il piano editoriale alterna contenuti educativi, recensioni dei pazienti e posizionamento, per spiegare i trattamenti in modo semplice e trasmettere professionalità e fiducia.",
        services: ["Gestione Social", "Piano editoriale", "Contenuti educativi"],
        results: [],
        url: "",
        logo: "",
        image: "",
