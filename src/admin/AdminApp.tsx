...
// L'autenticazione usa Supabase Auth (email + password).
    ...
    >
      ...
      <div
        style={{
          ...
          width: 600,
          height: 600,
          background: 'rgba(205,178,255,0.04)',
          borderRadius: '50%',
          filter: 'blur(120px)',
      ...
      >
        ...
        <p style={{ fontSize: 13, color: 'var(--m)', marginBottom: '2rem', lineHeight: 1.5 }}>
          Inserisci le credenziali admin per gestire il sito.
        </p>
        ...
        <button
          ...
          disabled={loading}
          className="btn btn-p"
          style={{ width: '100%', marginTop: '1.5rem', justifyContent: 'center', opacity: loading ? 0.6 : 1 }}
        >
          {loading ? 'Accesso...' : 'Entra'}
        </button>

        <div style={{ fontSize: 11, color: 'var(--m)', marginTop: '1.5rem', textAlign: 'center', lineHeight: 1.6 }}>
          Primo accesso? Crea l'utente admin dalla dashboard Supabase:<br />
...
const SetupRequired = () => (
  ...
  >
    ...
    >
      ...
      <h1 style={{ fontFamily: 'var(--fd)', fontSize: '2rem', letterSpacing: '.02em', marginBottom: '1rem' }}>
        DASHBOARD NON CONFIGURATA
      </h1>
      <p style={{ fontSize: 14, color: 'var(--m)', lineHeight: 1.6, marginBottom: '1.5rem' }}>
        Per usare la dashboard devi configurare Supabase. Apri il file <code style={{ color: 'var(--a)' }}>SETUP.md</code> nella root del progetto e segui i passi (5 minuti).
      </p>
      <div
        style={{
          padding: '1rem',
      ...
      >
        1. Crea progetto su supabase.com<br />
        2. Esegui supabase/schema.sql nel SQL Editor<br />
        3. Copia .env.example in .env e compila le chiavi<br />
        4. Riavvia <code>npm run dev</code>
      </div>
    </div>
  </div>
);
